...
<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
		...
		<form id ="challengeForm" action="aggiornaChallenge" method="post">
	      <div class="row">
				  		...
				  		<div class="container p-0">	  						
	    					<div class="row">
	    						<div class="p-2">
							      ...
							      <input type="text" class="form-control" id="name" name="name" value="I classici del 900" disabled>
							    </div>
	  						</div>
	  						<div class="row">
	    						<div class="p-2">
							      <label for="endDate"><b>Termina il</b></label>
								  <input id="endtDate" class="form-control" type="date" value="31/12/2025" disabled />
							    </div>
	  						</div>
	  						<div class="row">
	    						<div class="p-2">
							      <label for="desc" class="form-label"><b>Descrizione</b></label>
  								  <textarea class="form-control" id="desc" rows="15" name="desc" disabled>La challenge propone alcuni dei classici del 900 ...</textarea>
							    </div>
	  						</div>
	  						<div class="p-2">
